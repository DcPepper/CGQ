...
class Command(BaseCommand):
	...
	def add_arguments(self, parser):
		parser.add_argument("--file", "-f", help="convert a file input of romaji into the selected mode")
		parser.add_argument("--hira", action="store_true")
		parser.add_argument("--kata", action="store_true")
    
	def handle(self, *args, **options):
		#if options.get("hira") is None and options.get("kata") is None:
		#    print("Please select either hira or kata mode")
		...
		for line in content.split('\n'):
			output.append(romajiToJapanese(line))
